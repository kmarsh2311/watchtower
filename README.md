...
[![Version](https://img.shields.io/badge/version-1.0.18-00f0ff?style=for-the-badge)](https://github.com/kmarsh2311/watchtower/releases/tag/v1.0.18)
...
1. Download [`librarymanager.zip` from the v1.0.18 release](https://github.com/kmarsh2311/watchtower/releases/download/v1.0.18/librarymanager.zip).
