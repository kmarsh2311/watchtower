...
[![Version](https://img.shields.io/badge/version-1.0.14-00f0ff?style=for-the-badge)](https://github.com/kmarsh2311/watchtower/releases/tag/v1.0.14)
...
1. Download [`librarymanager.zip` from the v1.0.13 release](https://github.com/kmarsh2311/watchtower/releases/download/v1.0.14/librarymanager.zip).
